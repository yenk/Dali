...
This runner is intentionally dependency-free beyond the corpus/ package
...
-----
    ...
    python runners/run_integrity.py ... --include-pre-canonical

    # Allow cross-version aggregation (produces a warning in output):
    python runners/run_integrity.py ... --allow-cross-version
...
from corpus.policy import POLICY_VERSION, assert_same_version_or_raise
...
from corpus.validator import filter_scoring_eligible, validate_corpus
